...
<body>
    ...
    <div class="loader_skeleton">
                    ...
                    <div class="col-sm-12">
                        <div class="main-menu border-section border-top-0">
                            ...
                            <div class="brand-logo layout2-logo">
                                <a href="#"><img src="../assets/images/icon/logo/6.png"
        ...
        <section class="collection-banner large-banner banner-padding">
            <div class="container">
                <div class="row ">
                    <div class="col-md-4">
                        <div class="ldr-bg">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="main-menu border-section border-top-0">
                                                        ...
                                                        <div class="row m-0">
                                                            ...
                                                            <div class="col-xl-4">
                                                                <a href="#" class="mega-menu-banner"><img
                                                                        src="../assets/images/mega-menu/flower/3.jpg"
                        ...
                        <div class="brand-logo layout2-logo">
                            <a href="#"><img src="../assets/images/icon/logo/6.png" class="img-fluid blur-up lazyload"
                                    alt=""></a>
                        </div>
                        <div class="menu-right pull-right">
                            <div class="icon-nav">
                                        ...
                                        <ul class="show-div shopping-cart">
                                            ...
                                            <li>
                                                <div class="buttons"><a href="cart.html" class="view-cart">view cart</a>
                                                    <a href="#" class="checkout">checkout</a></div>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                                ...
                                <li><a href="#">pages</a>
                                    <ul>
                                        ...
                                        <li>
                                            <a href="#">account</a>
                                            <ul>
                                                <li><a href="product-page(left-image).html">account <span
                                                            class="new-tag">new</span></a></li>
                                                <li><a href="product-page(right-image).html">order history <span
                                                            class="new-tag">new</span></a></li>
                                                ...
                                                <li><a href="profile.html">profile <span class="new-tag">new</span></a>
                                                </li>
                                        ...
                                        <li><a href="typography.html">typography <span class="new-tag">new</span></a>
                                        </li>
                        ...
                        <div class="row">
                            <div class="col">
                                <div class="slider-contain">
                                    <div>
                                        <h4>save upto 10%</h4>
                                        <h1>pre-made & custom</h1><a href="#" class="btn btn-solid">shop now</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <a href="#">
                        <div class="collection-banner p-left text-center">
                            <div class="img-part">
                                <img src="../images/XXXMMMNNN.png" class="img-fluid blur-up lazyload"
                                    alt="">
                            </div>
                        </div>
                    </a>
                                    ...
                                    <div class="product-box product-wrap">
                                        <div class="img-wrapper">
                                            <div class="front text-center">
                                                <a href="#"><img src="../assets/images/flower/product/7.jpg"
                                                        class="img-fluid blur-up lazyload" alt=""></a>
                                            </div>
                                            <div class="cart-box">
    ...
    <!-- blog section -->
    <section class="blog flower-bg section-b-space ratio3_2">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="title4">
                ...
                <div class="col-md-12">
                    ...
                    <div class="slide-5 no-arrow slick-instagram">
                        ...
                        <div>
                            <a href="#">
                                <div class="instagram-box">
                                    <img src="../assets/images/flower/insta/3.jpg" class="bg-img" alt="Avatar"
                                        style="width:100%">
                ...
                <div class="row footer-theme partition-f">
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="footer-contant">
                            <div class="footer-logo"><img src="../assets/images/icon/logo/6.png" alt=""></div>
        ...
        <div class="setting_box_body">
            ...
            <div class="setting-body">
                ...
                <div class="setting-contant">
                    <ul class="color-box">
                        <li>
                            <input id="ColorPicker1" type="color" value="#fa869b" name="Background">
